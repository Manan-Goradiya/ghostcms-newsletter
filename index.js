...
//       console.log("access key is ", this.accessKeyId )
//     }

//     if (this.endpoint !== '') {
// 	console.log("endpoint is not set,access key is" , this.accessKeyId )
...
//         }
//         this.s3()
//           .putObject(config, (err, data) => err ? reject(this.accessKeyId) : resolve(`${this.host}/${fileName}`))
//       })
